...
public final class TsExtractor implements Extractor {
  ...
  private static final int BUFFER_PACKET_COUNT = 7; // Should be at least 2
  public static int BUFFER_SIZE = TS_PACKET_SIZE * BUFFER_PACKET_COUNT;
  ...
  public int read(ExtractorInput input, PositionHolder seekPosition)
    ...
    if (payloadExists) {
      ...
      if (payloadReader != null) {
        if (discontinuityFound) { payloadReader.seek();
